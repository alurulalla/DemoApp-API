...
namespace DemoApp.API.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, MessageParams messageParams)
        {
            ...
            var messagesFromReop = await _repo.GetMessagesForUser(messageParams);

            var messages = _mapper.Map<IEnumerable<MessageToReturnDto>>(messagesFromReop);

            Response.AddPagination(messagesFromReop.CurrentPage, 
                                messagesFromReop.PageSize, 
                                messagesFromReop.TotalCount, 
                                messagesFromReop.TotalPages);
